  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-200 via-indigo-300 to-blue-500 py-40 px-6 flex flex-col items-center pb-24">
      ...
      <p className="text-lg text-gray-100 mb-16 max-w-lg text-center">
        Select an option to start building or customizing your robotic solution
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full max-w-4xl">
        ...
        >
          ...
          <p className="text-gray-700 text-center">
            Design a new robot from scratch with custom features to meet your
        ...
        >
          ...
          <p className="text-gray-700 text-center">
            Modify an existing robot model to better fit your unique project
