...
const Home = () => {
    ...
    return (
      <div className="mt-20 ">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="text-lg  text-justify text-gray-600 mb-4">
                ...
                cutting-edge AI, our marine vehicles navigate the depth and
                breadth of the ocean with unparalleled precision and a profound
                commitment to the ecosystem.
              </p>
              <p className="text-lg  text-justify text-gray-600">
                Your gateway to intelligent marine exploration begins here —
                where every ripple echoes with innovation, and every tide
        ...
        <div className="grid-cols-6 md:grid-cols-2    ">
          <div className=" container mx-auto py-12 px-4 md:px-0">
            <div
            ...
            >
              ...
              <Link to="/contact">
                <button className=" ml-4 py-2 px-4 rounded shadow-xl  bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent  hover:text-gray-200 transition duration-300">
                  Contact Us
                </button>
              </Link>
            </div>
        ...
        <div className="container mx-auto py-12 px-4 md:px-0">
          <div className="grid grid-cols-12 md:grid-cols-2 gap-12 items-center  ">
            <div>
              <img
                src={specializationImage}
                alt="Our Specialization"
                className="items-start  rounded-lg shadow-lg w-[400px] h-[400px]"
              />
            </div>
            <div>
              ...
              <p className="text-lg text-justify  text-gray-600 mb-4 mt-5">
                ...
                engineered with precision, representing values essential to
                modern marine operations. Whether you’re in the oil and gas
                sector, offshore industries, or the realm of marine science, our
        ...
        <div className="  p-8 rounded-lg  text-center mb-12 mt-12">
          ...
          <div className={"flex justify-center gap-8"}>
            <Link to="/products">
              <button className="py-2 px-4 rounded shadow-xl  bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent  hover:text-gray-200 transition duration-300">
                View Products
              </button>
            </Link>
            <Link to="/services">
