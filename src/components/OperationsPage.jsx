...
const OperationsPage = () => {
    ...
    return (
        <div
            className="flex h-screen bg-gradient-to-r from-indigo-500 via-blue-500 to-pink-500 text-white transition-all duration-300"
        >
            {/* Button Area */}
            <div
            ...
            >
                ...
                <div className="space-y-4 w-full max-w-md">
                    <button
                        ...
                        className={`w-full py-3 bg-gradient-to-r from-blue-400 to-indigo-500 text-white font-bold rounded-lg shadow-lg hover:from-purple-500 hover:to-indigo-600 focus:outline-none focus:ring-2 focus:ring-purple-300 transition-transform ${activeForm === 'staff' ? 'transform scale-105' : ''
                            }`}
                    >
                        Staff Operations
                    </button>
                    ...
                    <button
                        ...
                        className={`w-full py-3 bg-gradient-to-r from-blue-400 to-indigo-500 text-white font-bold rounded-lg shadow-lg hover:from-purple-500 hover:to-indigo-600 focus:outline-none focus:ring-2 focus:ring-purple-300 transition-transform ${activeForm === 'robot' ? 'transform scale-105' : ''
                            }`}
                    >
                        Robot Operations
                    </button>
            ...
            >
                {activeForm === 'staff' && (
                    <form className="w-full animate-fade-in space-y-6 bg-gray-100 p-6 rounded-lg shadow-lg mt-20"> {/* Added mt-20 for margin */}
                        <h2 className="text-3xl font-bold mb-4 text-blue-600">Staff Operations Form</h2>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            <label className="block mb-2 font-semibold">Create Account: Role</label>
                            <select className="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300">
                ...
                {activeForm === 'robot' && (
                    <form className="w-full animate-fade-in space-y-6 bg-gray-100 p-6 rounded-lg shadow-lg mt-20">
                        <h2 className="text-3xl font-bold mb-4 text-blue-600">Robot Operations Form</h2>
                        <div className="mb-4 ">
                        ...
                        <div className="mb-4">
                            <label className="block mb-2 font-semibold">Component Types</label>
                        ...
                        <div className="mb-4">
                            <label className="block mb-2 font-semibold">Component Models</label>
                            <select className="w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-purple-300">
                ...
                {activeForm === 'service' && (
                    <form className=" w-full animate-fade-in space-y-6 bg-gray-100 p-6 rounded-lg shadow-lg mt-20">
                        <h2 className="text-3xl font-bold mb-4 text-blue-600">Service Operations Form</h2>
                        <div className="mb-4">
