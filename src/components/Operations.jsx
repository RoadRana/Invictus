    ...
    <div className="flex flex-col items-center justify-start h-full bg-gray-50 p-8 text-gray-800 space-y-12">
      ...
      <div className="w-full max-w-2xl p-6 bg-white shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="accountRole" className="block mb-2 text-lg">
              Create Account: Role
            </label>
            <select
              id="accountRole"
          ...
          <div className="mb-4">
            <label htmlFor="viewUser" className="block mb-2 text-lg">
              View Users
            </label>
            <select
              id="viewUser"
      ...
      <div className="w-full max-w-2xl p-6 bg-white shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="robotType" className="block mb-2 text-lg">
              Robot Types
            </label>
            <select
              id="robotType"
          ...
          <div className="mb-4">
            <label htmlFor="robotModel" className="block mb-2 text-lg">
              Robot Model
            </label>
            <select
              id="robotModel"
          ...
          <div className="mb-4">
            <label htmlFor="componentType" className="block mb-2 text-lg">
              Component Types
            </label>
            <select
              id="componentType"
          ...
          <div className="mb-4">
            <label htmlFor="componentModel" className="block mb-2 text-lg">
              Component Models
            </label>
            <select
              id="componentModel"
          ...
          <div className="mb-4">
            <label htmlFor="robotIcon" className="block mb-2 text-lg">
              Robot Icon
            </label>
            <select
              id="robotIcon"
      ...
      <div className="w-full max-w-2xl p-6 bg-white shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="service" className="block mb-2 text-lg">
              Create Service
            </label>
            <select
              id="service"
          ...
          <div className="mb-4">
            <label htmlFor="serviceName" className="block mb-2 text-lg">
              Name
            </label>
            <select
              id="serviceName"
          ...
          <div className="mb-4">
            <label htmlFor="serviceDescription" className="block mb-2 text-lg">
              Description
            </label>
            <select
          ...
          <div className="mb-4">
            <label htmlFor="serviceApproach" className="block mb-2 text-lg">
              Approach
            </label>
            <select
              id="serviceApproach"
