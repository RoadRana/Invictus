...
const InfrastructureInspectionAndMaintenance = () => {
      ...
      <div className="mt-6">
        {
          ...
          <div
            id="InfrastructureInspectionAndMaintenance"
          ...
          >
                  ...
                  <div className="flex items-center justify-between">
                    <h3
                      className={`text-xl font-medium ${
                        visibleSection === item.replace(/ /g, "").toLowerCase()
                          ? "text-blue-600"
                          : "text-gray-800"
            ...
            <h3 className="text-2xl font-semibold text-blue-600 mb-5 mt-5">
              Our Approach
            </h3>
            <ol className="list-decimal list-inside text-gray-700 text-lg mb-6 leading-relaxed">
              ...
              {/* for future the other items should be added here */}
              {/* ... */}
            </ol>
...
export default InfrastructureInspectionAndMaintenance;
