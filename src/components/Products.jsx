  ...
  const toggleTab = (index, tabIndex) => {
    setActiveTabs(
      activeTabs.map((activeTab, i) =>
        i === index ? (activeTab === tabIndex ? null : tabIndex) : activeTab
      )
    );
  };
      ...
      items: [
        {
          ...
          description:
            'Capture clear, detailed images for advanced analysis and operations.',
        },
        {
          title: 'Infrared Imaging',
          description:
            'See beyond visible light with infrared sensors, perfect for low-light conditions.',
        },
        {
          title: 'Lidar Scanners',
          description:
            'Use laser-based technology to measure distances with high precision.',
        },
      ],
    },
    powerSupply: {
      ...
      items: [
        {
          ...
          description:
            'Efficiently manage power with our advanced battery systems.',
        },
        {
          title: 'Redundant Power Sources',
          description:
            'Ensure uninterrupted operation with dual power sources.',
        },
        {
          title: 'Solar Integration',
          description:
            'Eco-friendly power solutions with integrated solar modules.',
        },
      ],
    },
    sensors: {
      ...
      items: [
        {
          ...
          description:
            'Monitor environmental conditions with high-accuracy temperature sensors.',
        },
        {
          title: 'Pressure Sensors',
          description: 'Get real-time pressure readings for in-depth analysis.',
        },
        {
          title: 'Proximity Sensors',
          description:
            'Detect objects and obstacles with advanced proximity sensing technology.',
        },
      ],
    },
    enclosures: {
      ...
      items: [
        {
          title: 'Waterproof Casings',
          description:
            'Protect your equipment with durable waterproof enclosures.',
        },
        {
          title: 'Impact-Resistant Frames',
          description: 'Built to withstand tough conditions and harsh impacts.',
        },
        {
          title: 'Heat Dissipation Design',
          description: 'Engineered to prevent overheating during extended use.',
        },
      ],
    },
    connectors: {
      ...
      items: [
        {
          title: 'Quick-Release Connectors',
          description: 'Easily connect and disconnect components on the go.',
        },
        {
          title: 'Waterproof Connectors',
          description: 'Maintain secure connections, even underwater.',
        },
        {
          title: 'High-Durability Pins',
          description:
            'Ensure long-lasting, reliable connections with durable pins.',
        },
      ],
    },
  };
    ...
    <div className="mt-20">
      ...
      <div className="container mx-auto py-12 px-4 md:px-0 ">
        ...
        {visibleSection && sectionContent[visibleSection] && (
          <Section
            title={sectionContent[visibleSection].title}
            items={sectionContent[visibleSection].items}
